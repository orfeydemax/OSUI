...
1.  **Consult `PROJECT_BRAIN.yaml`** → Check project state, config, and OS stack.
2.  ⛔ **RULE: DO NOT execute unconditional Read tool for plan files unless specifically required by track level.**
