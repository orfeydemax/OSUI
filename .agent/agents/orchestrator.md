...
- [ ] **Consult `PROJECT_BRAIN.yaml`** first.
- [ ] ⛔ **RULE: DO NOT execute Read tool for `ARCHITECTURE.md` unless the routing track is EXACTLY Extended or Critical. Violation will cause token burn.**
- [ ] **Identify relevant scripts** (e.g., `playwright_runner.py` for web) based on context, and **EXECUTE** them when needed.

## 🛑 PHASE 0: QUICK CONTEXT CHECK

**Before planning, quickly check:**
1.  **Check** if plan files are mentioned in `PROJECT_BRAIN.yaml` or conversation log. Conditionally read them only if required.
