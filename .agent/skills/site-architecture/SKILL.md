...
description: "Планирование или реструктуризация иерархии сайта, навигации, шаблонов URL, хлебных крошек и внутренних ссылок. Используйте при проектировании структуры разделов сайта."
risk: unknown
