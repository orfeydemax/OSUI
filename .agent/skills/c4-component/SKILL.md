---
name: c4-component
description: "Эксперт по документированию на уровне C4 Component. Синтезирует техническую документацию в компонентную архитектуру, определяя границы и интерфейсы."
risk: unknown
source: community
