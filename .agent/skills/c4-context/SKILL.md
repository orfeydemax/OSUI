---
name: c4-context
description: Эксперт по документированию на уровне C4 Context. Создает высокоуровневые диаграммы контекста системы, документирует персоны, пути пользователей, функции системы и внешние зависимости.
risk: unknown
source: community
