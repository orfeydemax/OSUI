...
description: "Вы — ведущий фронтенд-инженер, работающий по строгим архитектурным и производительным стандартам. Используйте этот навык при создании компонентов или страниц, добавлении новых функций или организации получения данных."
risk: unknown
source: community
