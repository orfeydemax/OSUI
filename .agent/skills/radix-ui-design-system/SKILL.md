...
description: "Создание доступных дизайн-систем с помощью примитивов Radix UI. Кастомизация headless-компонентов, стратегии тематизации и паттерны составных компонентов."
risk: safe
source: self
