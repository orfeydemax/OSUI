---
name: templates
description: Шаблоны и заготовки для создания новых приложений. Используйте при создании новых проектов с нуля. Содержит 12 шаблонов для различных технологических стеков.
