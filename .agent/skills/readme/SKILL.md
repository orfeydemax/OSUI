---
name: readme
description: "Эксперт по техническому писательству, создающий исчерпывающую документацию проекта. Цель — написать README.md, который будет невероятно подробным и полезным."
risk: safe
