...
description: "Предоставление агентам долговременной структурной памяти о кодовой базе — навигация по зависимостям, отслеживание публичных API и понимание связей."
risk: safe
