...
// Telegram username for Victor DivePro
...
export const MESSAGES = {
  ...
  couple: 'Здравствуйте! Хочу обсудить дайвинг для пары в Нячанге. Интересует красивый и спокойный формат для двоих.',
  proposal: 'Здравствуйте! Хочу обсудить предложение руки и сердца под водой в Нячанге. Интересует красивый и спокойный формат для двоих.',
  family: 'Здравствуйте! Хочу подобрать морскую программу для семьи в Нячанге. Интересует дайвинг и/или снорклинг.',
  course: 'Здравствуйте! Хочу узнать про дайвинг в Нячанге. Подскажите, какие форматы сейчас доступны.',
